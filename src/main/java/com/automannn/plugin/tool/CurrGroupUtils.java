...
public final class CurrGroupUtils {
     ...
     * @return 前端模板组对象
     */
    public static FrontTemplateGroup getCurrFrontTemplateGroup() {
        Settings settings = Settings.getInstance();
        String groupName = settings.getCurrFrontTemplateGroupName();
        return settings.getFrontTemplateGroupMap().get(groupName);
    }
     ...
     *
     * @param groupName     组名
     * @param frontTemplateGroup 前端模板组对象
     */
    public static void setCurrFrontTemplateGroup(String groupName, FrontTemplateGroup frontTemplateGroup) {
        frontTemplateGroup.setName(groupName);
        Settings.getInstance().getFrontTemplateGroupMap().put(groupName, frontTemplateGroup);
    }
