package com.automannn.plugin.service;

import com.automannn.plugin.entity.FrontTemplate;
...
public interface CodeGenerateService {
     ...
     * @param title         是否显示提示
     */
    void generateFrontByUnifiedConfig(Collection<FrontTemplate> frontTemplates, boolean unifiedConfig, boolean title);
