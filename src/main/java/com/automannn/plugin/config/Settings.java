package com.automannn.plugin.config;
...
public class Settings implements PersistentStateComponent<Settings> {
    ...
    @Transient
    private static final String FRONT_DEFAULT_NAME = "FrontDefault";
     ...
     * 当前前端模板组名
     */
    private String currFrontTemplateGroupName;
    /**
     * 模板组
     */
     ...
     * 前端模板组
     */
    private Map<String, FrontTemplateGroup> frontTemplateGroupMap;
    /**
     * 当前配置表组名
     */
    ...
    public void initDefault() {
        ...
        this.version = "1.2.4";
        // 作者名称
        this.author = "automannn";
        // 当前各项分组名称
        this.currTemplateGroupName = DEFAULT_NAME;
        this.currFrontTemplateGroupName = FRONT_DEFAULT_NAME;
        ...
        if (this.frontTemplateGroupMap == null) {
            this.frontTemplateGroupMap = new LinkedHashMap<>();
        }
        ...
        this.templateGroupMap.put("MybatisPlus", loadTemplateGroup("MybatisPlus", "entity", "readmapper", "readdao","writemapper","writedao","readservice",
     ...
     * @return 模板组
     */
    private static FrontTemplateGroup loadFrontTemplateGroup(String groupName, String... templateNames) {
        FrontTemplateGroup frontTemplateGroup = new FrontTemplateGroup();
        frontTemplateGroup.setName(groupName);
        frontTemplateGroup.setElementList(new ArrayList<>());
        for (String templateName : templateNames) {
            String path = "/template/" + groupName + "/" + templateName + ".vm";
            frontTemplateGroup.getElementList().add(new FrontTemplate(templateName, loadTemplate(path)));
        }
        return frontTemplateGroup;
    }
